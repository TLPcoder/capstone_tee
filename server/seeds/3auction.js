    ...
    .then(function () {
      return Promise.all([
        ...
        knex('auction').insert({
            ...
            owner_id: 4,
            top_bid:390,
            tee_time: new Date('2017-01-22 14:30:00 UTC'),
            'auction_ends': new Date('2017-01-20 24:00:00 UTC')
        }),
        knex('auction').insert({
            //id: 3,
            course_id: 5,
            owner_id: 5,
            top_bid:190,
            tee_time: new Date('2017-01-25 6:30:00 UTC'),
            'auction_ends': new Date('2017-01-23 24:00:00 UTC')
        }),
        knex('auction').insert({
            //id: 3,
            course_id: 6,
            owner_id: 6,
            top_bid:210,
            tee_time: new Date('2017-01-25 7:30:00 UTC'),
            'auction_ends': new Date('2017-01-23 24:00:00 UTC')
        }),
        knex('auction').insert({
            //id: 3,
            ...
            owner_id: 7,
            top_bid:200,
            tee_time: new Date('2017-01-29 9:30:00 UTC'),
            'auction_ends': new Date('2017-01-27 24:00:00 UTC')
        }),
        knex('auction').insert({
            //id: 3,
            course_id: 8,
